// To generate card arrays: 
//`cards.whiteCards.map(card => card.text)`
//`cards.blackCards.filter(card => card.pick === 1).map(card => card.text)`
...
export const whiteCards = ['Coat hanger abortions.',
    'Man meat.',
    'Autocannibalism.',
    'Vigorous jazz hands.',
    'Flightless birds.',
